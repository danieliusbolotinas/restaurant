...
@section('content')
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body" >
            <form method="POST" action="/admin/user/store" class="form-horizontal" enctype="multipart/form-data" role="form">
                {!! csrf_field() !!}
                <fieldset>
                    <!-- Text input-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="is_admin" type="is_admin" class="form-control" name="is_admin" value="0" required>
                            </div>
                        </div>
